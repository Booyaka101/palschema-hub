...
const FILES = ['index.html', 'items.html', 'buildings.html', 'values.html', 'diff.html', 'index.json', 'items.json', 'buildings.json', 'versions.json', 'LICENSE'];
const DIRS = ['schemas', 'structs', 'diffs', 'values'];
const CLI_FILES = [
